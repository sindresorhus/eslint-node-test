...
| [consistent-assert-throws-callback-style](docs/rules/consistent-assert-throws-callback-style.md) | Enforce a consistent body style for `assert.throws()` callbacks.                                           |      | 🔧 |    |
